...
local_fusesoc=r/'.tools'/'fusesoc-2.4.7'/'bin'/'fusesoc'
if not local_fusesoc.is_file(): errors.append('missing project FuseSoC 2.4.7; run make setup')
